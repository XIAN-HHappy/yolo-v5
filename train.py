...
wdir = 'model_exp_hand_x' + os.sep  # weights dir
last = wdir + 'last.pt'
best = wdir + 'best.pt'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='models/yaml/yolov5x.yaml', help='*.cfg path')
    parser.add_argument('--data', type=str, default='data/hand.yaml', help='*.data path')
    ...
    parser.add_argument('--weights', type=str, default='./pretrain_models/yolov5x.pt', help='initial weights path')
