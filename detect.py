...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='person_weights/last2.pt', help='model.pt path')
    parser.add_argument('--source', type=str, default='H:/git_project/deep_sort_pro/deep_sort_pytorch/video/dance0.mp4', help='source')  # file/folder, 0 for webcam
